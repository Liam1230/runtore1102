...
export default {
	data: () => ({
		...
		extraquize2srcs:[
			...
			{checked:false,score:0,item:"ハーフを1時間51分~52分で走ることができる"},
		],
		extraquize2point:0,
		extraquize2selected:[],
		...
		extraquize3srcs:[
			...
			{checked:false,score:6,item:"ハーフを1時間51分~52分で走ることができる"},
		],
		extraquize3point:0,
		extraquize3selected:[],
		...
		extraquize4srcs:[
			...
			{checked:false,score:0,item:"ハーフを1時間22分~25分で走ることができる"},
		],
		extraquize4point:0,
		extraquize4selected:[],
		toatlFormandTec:0,
